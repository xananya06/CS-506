...
ax.fill_between(
    forecast_full['ds'],
    forecast_full['yhat_lower'] / 1_000_000,
    forecast_full['yhat_upper'] / 1_000_000,
    color='blue',
    alpha=0.2,
...
ax.set_title('BPD Overtime Forecast (Prophet with Hyperparameter Tuning and 95% CI)', fontsize=16, fontweight='bold')
...
plt.tight_layout()
plt.show()
lower_95 = forecast_2025['yhat_lower'].iloc[0]
upper_95 = forecast_2025['yhat_upper'].iloc[0]
print(f"95% Confidence Interval for 2025: ${lower_95:,.2f} to ${upper_95:,.2f}")
